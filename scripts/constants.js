...
export const ACTION_TYPE = {
  ...
  infusion: "TYPES.Item.infusion",
  barbarousskill: "TYPES.Item.barbarousskill",
  essenceweave: "TYPES.Item.essenceweave",
...
export const GROUP = {
  ...
  infusion: {
    id: "infusion",
    name: "TYPES.Item.infusion",
    type: "system",
  },
  barbarousskill: {
    id: "barbarousskill",
    name: "TYPES.Item.barbarousskill",
    type: "system",
  },
  essenceweave: {
    id: "essenceweave",
    name: "TYPES.Item.essenceweave",
    type: "system",
  },
  otherfeature: {
    id: "otherfeature",
...
export const ITEM_TYPE = {
  ...
  infusion: { groupId: "infusion" },
  barbarousskill: { groupId: "barbarousskill" },
  essenceweave: { groupId: "essenceweave" },
